...
const JWT_SECRET = process.env.JWT_SECRET || 'bear-app-secret-key-2024';

// 数据文件路径
// 支持通过环境变量配置（如Render的持久化磁盘）
...
if (fs.existsSync(distPath)) {
  console.log('[INIT] 📦 检测到前端构建文件，启用静态文件服务');
  ...
  console.log('[INIT] ⚠️ 未检测到前端构建文件，仅提供API服务');
}
